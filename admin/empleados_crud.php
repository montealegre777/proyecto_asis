    ...
    <div class="container py-4">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="list-group list-group-flush">
                    <a href="?accion=listar" class="list-group-item list-group-item-action py-3"><i
                            class="fa-solid fa-users text-primary me-3"></i> Listar empleados</a>
                    <a href="?accion=crear_form" class="list-group-item list-group-item-action py-3"><i
                            class="fa-solid fa-user-plus text-success me-3"></i> Crear empleado</a>
                    <a href="?accion=editar_form" class="list-group-item list-group-item-action py-3"><i
                            class="fa-solid fa-user-pen text-warning me-3"></i> Actualizar empleado</a>
                    <a href="?accion=reportes" class="list-group-item list-group-item-action py-3 bg-light fw-bold"><i
                            class="fa-solid fa-file-invoice text-danger me-3"></i> Ver Reportes de Asistencia</a>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-success fw-bold">
                                    ...
                                    <?= htmlspecialchars($asist['sample'] ?? $asist['hora_entrada']) ?>
                                </td>
        ...
        <div class="card shadow-sm p-4">
            ...
            <form action="" method="GET" class="row g-3 align-items-center">
                ...
                <div class="col-sm-6">
                    <input type="number" name="id" class="form-control" placeholder="Número de documento" required
                        min="1">
                </div>
                <div class="col-sm-6">
                    <button type="submit" class="btn btn-success"><i class="fa-solid fa-magnifying-glass"></i>
                        Buscar</button>
                </div>
            </form>
            <p class="mt-3"><a href="?accion=menu" class="btn btn-secondary">- Volver al menú</a></p>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="area_id" class="form-select">
                                ...
                                <?php foreach ($areas as $a): ?>
                                <option value="<?= $a['id'] ?>"
                                    <?= $empleado_editar['id_area'] == $a['id'] ? 'selected' : '' ?>>
